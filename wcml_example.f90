...
!
  ...
  call cmlAddProperty(xf=myfile, title='inputSize', property='True')
  call cmlAddProperty(xf=myfile, title='inputSize', property=.True.)
  call cmlAddProperty(xf=myfile, title='inputSize', property=3)
  call cmlAddProperty(xf=myfile, title='inputSize', property=3.0)
  call cmlAddProperty(xf=myfile, title='inputSize', property=3.0d0)

  call cmlAddProperty(xf=myfile, title='inputArray', property=(/'one', 'two'/))
  call cmlAddProperty(xf=myfile, title='inputArray', property=(/.true., .false./))
  call cmlAddProperty(xf=myfile, title='inputArray', property=(/1, 2/))
  call cmlAddProperty(xf=myfile, title='inputArray', property=(/1.0, 2.0/))
  call cmlAddProperty(xf=myfile, title='inputArray', property=(/1.0d0, 2.0d0/))
