...
dnl
dnl ***********************************************
dnl Copies of the above setter and getter functions
dnl set up for vst's rather than arrays of chars
dnl - this seems like a sensible approach while
dnl I mostly work on the sax module.
dnl FIXME: but eventually I don't want two copes of
dnl these.
dnl ***********************************************
define(`AMW_m_dom_get', `dnl
dnl
dnl Provide a getter for the object:
dnl object is presumed to be a node named np
dnl $1 is attribute type
