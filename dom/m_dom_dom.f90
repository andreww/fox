...
!  function getSystemId(docType) result(c) See m_dom_common
  ...
  pure function getinternalSubset_length(np, p) result(n)
    type(Node), intent(in) :: np
    logical, intent(in) :: p
    integer :: n
  ...
  end function getinternalSubset_length
function getinternalSubset(np, ex)result(c) 
    type(DOMException), intent(out), optional :: ex
    type(Node), pointer :: np
    character(len=getinternalSubset_length(np, associated(np))) :: c
...
if (present(ex)) then
  ...
  pure function getnotationName_length(np, p) result(n)
    type(Node), intent(in) :: np
    logical, intent(in) :: p
    integer :: n
  ...
  end function getnotationName_length
function getnotationName(np, ex)result(c) 
    type(DOMException), intent(out), optional :: ex
    type(Node), pointer :: np
    character(len=getnotationName_length(np, associated(np))) :: c
...
if (present(ex)) then
  ...
  pure function getdata_length(np, p) result(n)
    type(Node), intent(in) :: np
    logical, intent(in) :: p
    integer :: n
  ...
  end function getdata_length
function getdata(np, ex)result(c) 
    type(DOMException), intent(out), optional :: ex
    type(Node), pointer :: np
    character(len=getdata_length(np, associated(np))) :: c
...
if (present(ex)) then
  ...
  pure function getname_length(np, p) result(n)
    type(Node), intent(in) :: np
    logical, intent(in) :: p
    integer :: n
  ...
  end function getname_length
function getname(np, ex)result(c) 
    type(DOMException), intent(out), optional :: ex
    type(Node), pointer :: np
    character(len=getname_length(np, associated(np))) :: c
...
if (present(ex)) then
  ...
  pure function getpublicId_length(np, p) result(n)
    type(Node), intent(in) :: np
    logical, intent(in) :: p
    integer :: n
  ...
  end function getpublicId_length
function getpublicId(np, ex)result(c) 
    type(DOMException), intent(out), optional :: ex
    type(Node), pointer :: np
    character(len=getpublicId_length(np, associated(np))) :: c
...
if (present(ex)) then
  ...
  pure function getsystemId_length(np, p) result(n)
    type(Node), intent(in) :: np
    logical, intent(in) :: p
    integer :: n
  ...
  end function getsystemId_length
function getsystemId(np, ex)result(c) 
    type(DOMException), intent(out), optional :: ex
    type(Node), pointer :: np
    character(len=getsystemId_length(np, associated(np))) :: c
